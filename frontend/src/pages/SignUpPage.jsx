...
const SignUpPage = () => {
	...
	return (
		<div className='flex flex-col justify-center py-12 sm:px-6 lg:px-8 bg-neutral-background min-h-[80vh]'>
			<motion.div
			...
			>
				<h2 className='mt-6 text-center text-3xl font-serif font-bold text-accent-brownMuted uppercase tracking-widest'>Create Account</h2>
			</motion.div>
					...
					<div className='mt-6'>
						<div className='relative'>
							...
							<div className='relative flex justify-center text-sm'>
								<span className='px-2 bg-white text-accent-brownMuted/60'>Already have an account?</span>
							</div>
						</div>
