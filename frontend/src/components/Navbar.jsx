      ...
      <header className="bg-neutral-background/95 backdrop-blur-md transition-all duration-300 border-b border-neutral-greige/20">
        <div className="container mx-auto px-4 pt-4 pb-2">
          <div className="flex justify-between items-center relative">
            ...
            <Link
              to="/"
              className="ml-1 text-3xl absolute left-1/2 transform -translate-x-1/2 font-serif font-bold text-accent-brownMuted tracking-widest uppercase"
            >
              ESTA
            </Link>
          ...
          <div className="flex justify-center gap-8 mt-4 text-xs font-semibold uppercase tracking-widest text-accent-brownMuted/80">
            <Link
              to="/"
              className="hover:text-primary-olive text-center transition border-b-2 border-transparent hover:border-primary-olive pb-1"
            >
